(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.BriefingUI=api})(typeof self!=='undefined'?self:this,function(){
  ...
  function summary(model){const c=attention(model);return`DYNAMIC AIRSPACE: ${c.active} active · ${c.partly_active} partly active · ${c.unknown} unknown · ${c.inactive} inactive · ${c.high} high/temporary NOTAMs`}
