const CACHE='soaring-notam-v2-9-2-faa-production-1';
const VERSION='2.9.2';
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/data/notams-live.json')||url.pathname.endsWith('/data/airspace-baseline.json')||url.pathname.endsWith('/data/dutch-dynamic-airspace.json')||url.pathname.endsWith('/data/nl-aip-sup-dynamic-airspace.json')||url.pathname.endsWith('/data/faa-refresh-status.json')){
